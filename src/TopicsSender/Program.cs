...
namespace TopicsSender // Note: actual namespace depends on the project name.
{
    internal static class Program
    {
        ...
        private static void RunPublishSubscribeMessageDemo(IModel model, TopicService service)
        {
            ...
            while (true)
            {
                ...
                service.SendTopicMessage(message, key, model);
            }
        }
    }
}